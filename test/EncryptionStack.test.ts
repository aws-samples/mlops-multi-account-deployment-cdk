...
describe('encryption-stack-test', () => {
  ...
  const template = Template.fromStack(new EncryptionStack(app, 'EncryptionStack', {
  ...
  test('Check if SSM parameter exists', () => {
    template.resourceCountIs('AWS::SSM::Parameter', 1);
    template.hasResourceProperties('AWS::SSM::Parameter', {
      Name: `/${TestAppConfig.applicationQualifier}/${EncryptionStack.ssmParameterName}`,
      Type: 'String',
    });
  });
