...
export class CodeCommitRepositoryConstruct extends Construct {
  readonly ENABLE_CODE_GURU_REVIEWER: boolean = true;
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    if (this.ENABLE_CODE_GURU_REVIEWER) {
        ...
        phases: {
          install: {
            commands: [
              ...
              `export CDK_QUALIFIER=${props.applicationQualifier}`, // required by CDKPipeline.pipelineCommands
            ],
          },
          build: {
    ...
    nag.NagSuppressions.addResourceSuppressions(this, [
      ...
      },
      {
        ...
        reason: 'Suppress AwsSolutions-CB3 - The pull request check uses a managed policy',
      },
      {
